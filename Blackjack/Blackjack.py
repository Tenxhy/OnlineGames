...
#################################################################""".strip())
        ...
        while balance > 0:
            ...
            if GameFunctions().isBlackjack(playerHand) and not GameFunctions().isBlackjack(dealerHand):
                print("# Blackjack! You win!")
                balance += bet*1.5

            elif GameFunctions().isBlackjack(playerHand) and GameFunctions().isBlackjack(dealerHand):
